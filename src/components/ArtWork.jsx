...
const ArtWork = () => {
  return (
    <section className="flex bg-customDark w-full h-full items-start justify-between px-[30px]">
      ...
      {/* Right Side: Art Content */}
      <div className="flex w-full pl-[30px] gap-[30px] justify-between">
        ...
        <div className="w-1/2 flex flex-col gap-8">
          <div className="w-full border border-1 border-white rounded-[40px] relative p-4 grid grid-cols-2 grid-rows-2 gap-4">
            ...
            {artContent.map((item) => (
              <div
                key={item.id}
                className="flex flex-col items-start justify-between px-3 py-4 font-asap gap-[150px]"
              >
                {/* Title and Arrow */}
                ...
                <div className="flex flex-col items-start">
                  <img
                    ...
                    className="mb-5"
                  />
                  <p className="text-white text-md text-justify">{item.text}</p>
                </div>
              </div>
            ))}
          </div>
          <div
            ...
            style={{
              ...
              backgroundSize: "cover", // You can customize this if needed
              backgroundPosition: "0% 45%", // Adjust this if you need a specific focus point
            }}
          ></div>
        </div>
        ...
        <div className="w-1/2">
          <div className="w-full">
            <div
              className="h-[18rem] rounded-[40px] mb-1"
              style={{
                backgroundImage: `url(${img1})`,
                backgroundSize: "cover", // You can customize this if needed
                backgroundPosition: "0% 40%", // Adjust this if you need a specific focus point
              }}
            ></div>

            {/* Second div with background image */}
            <div
              className="h-[16rem] rounded-[40px]"
              style={{
                backgroundImage: `url(${img1})`,
          ...
          <div className="flex w-full justify-center mt-[45px] pointer-events-none">
            <div className="flex gap-[30px] text-white w-full max-w-[1200px]">
              {" "}
              {/* Ensure the width doesn't change */}
              <div className="w-2/5 flex flex-col items-start">
                ...
                <p className="font-comforter font-bold text-[#e55c90] text-[4.5rem]">
                  Luminescent
                </p>
              </div>
              <div className="w-3/5">
                <img
                  className="rounded-[40px] object-cover h-[30rem] w-full"
                  src={img6}
                  alt=""
                />
              </div>
